<style>
 .body
 {
     background-image: url('./res/sexy_shooter/background.png');
     background-repeat: both;
 }
</style>
<div class="title_entry" style="background-image: url('./res/sexy_shooter/title.png">
</div>
...
<div class="white_text paragraph">
	...
	<?=$Dictionnary["SexyShooter"]; ?>
    </div>
</div>
<?php if (!$IsMobile) { ?>
    <div class="white_text paragraph insetbox" style="background-image: url('./res/sexy_shooter/pic0.png');">
    </div>
<?php } ?>

<div class="networks">
    <a href="./res/sexy_shooter/sexy_shooter.zip" target="_blank">
